...
\begin{figure}[H]
\includegraphics[trim={0cm 1.7cm 0cm 1.7cm},clip, scale =0.2]{Applications/tmd-mf/edge-mag.pdf}
\hspace{0.5cm}
\includegraphics[scale=0.53]{Applications/tmd-mf/edge-magzoom1}
...
\includegraphics[scale=0.53]{Applications/tmd-mf/freeBands}
...
\begin{figure}[H]
\centering
\includegraphics[trim={1.5cm 1.5cm 0cm 2cm},clip, scale =0.4]{Applications/tmd-mf/bandsZoomed.pdf}
	\caption[]{}
