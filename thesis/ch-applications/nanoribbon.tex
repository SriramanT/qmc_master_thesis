...
\end{equation}
\begin{figure}[H]
\includegraphics[scale=0.93]{Applications/MFnanoribbon.png}
\hspace{0.1cm}
\includegraphics[scale=0.5]{Applications/lattice_Nx=512_Ny=16_U=20_beta=100.png}
...
\end{figure}
%\begin{figure}[H]
%	\caption[Minimization of the grandpotential.]{Left: Right: Minimization of the grandpotential. 
