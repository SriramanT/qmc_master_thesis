...
\hspace{-1.2cm}
\includegraphics[scale = 0.5]{Applications/graphene-strain/CorrelationsDots.png}
...
\begin{figure}[H]
\includegraphics[scale = 0.5]{Applications/graphene-strain/S(q)pcolor.png}
\includegraphics[scale = 0.5]{Applications/graphene-strain/edgeStFactor_Graphene.png}
	\caption[]{}
	\label{fig:edgeStFactor}
\end{figure}
\begin{figure}[H]
\includegraphics[scale = 0.5]{Applications/graphene-strain/LongitudinalProfile.png}
\includegraphics[scale = 0.5]{Applications/graphene-strain/order_parameter_Graphene.png}
	\caption[]{}
	\label{fig:edgeStFactor}
\end{figure}
\begin{figure}[H]
\includegraphics[scale = 0.5]{Applications/graphene-strain/chiTyang2017.png}
\includegraphics[scale = 0.5]{Applications/graphene-strain/fityang2017.png}
	\caption[]{}
	\label{fig:edgeStFactor}
\end{figure}
...
\end{figure}
\begin{figure}[H]
\includegraphics[trim={0cm 8cm 0cm 6.5cm},clip, scale =0.45]{Applications/tmd-mf/edge-mag.pdf}
	\caption[]{}
...
\includegraphics[scale=0.4]{Applications/tmd-mf/superposedBands1} \\
