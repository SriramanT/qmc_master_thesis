...
\includegraphics[scale=0.55]{Applications/grandpotMin_Nx=512_Ny=16_U=16_beta=2.png}
	\caption[Example of the minimization of the grandpotential functional.]{Example of the minimization of the grandpotential functional $\Omega$ for a TMD nanoribbon of width $N_y = 16$, at inverse temperature $\beta = 2 t $, at $U = 16 t$. \label{fig:grandPotMin}}
\end{figure}