...
\centering
\includegraphics[width = 10cm]{Hubbard/Hydrogen.jpeg}
...
\begin{equation}
- \mathcal{H}_{K} \left| \bm k \right\rangle = \frac{1}{\sqrt{N}} \sum_{\bm r \bm r'} K ( \bm r - \bm r' ) e^{i \bm k \cdot \bm r} \left| \bm r' \right \rangle = \frac{1}{\sqrt{N}} \bigg( \sum_{\bm R} K(\bm R) e^{i\bm k \cdot \bm R} \bigg)\underbrace{ \bigg( \sum_{\bm r'} e^{i\bm k \cdot \bm r'} \left| \bm r' \right\rangle \bigg)}_{\left| \bm k \right\rangle} = \varepsilon_{\bm k} \left| \bm k \right\rangle
\end{equation}
...
\centering
\includegraphics[width = 6cm]{Hubbard/bipartite}
