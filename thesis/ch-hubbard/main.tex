...
\input{ch-hubbard/1.introduction.tex}
\input{ch-hubbard/2.motivation.tex}
\input{ch-hubbard/3.mott-insulators.tex}
\input{ch-hubbard/4.exact-solutions.tex}
\input{ch-hubbard/5.effective-heisenberg.tex}
\cleardoublepage
