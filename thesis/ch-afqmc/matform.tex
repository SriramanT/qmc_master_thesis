...
A convenient, and sparse approximation of $\bm B$ in real space is available, and it is obtained simply by appling the Trotter breakup to the exponential of the hopping matrix:
