...
\includegraphics[scale = 0.19]{Introduction/zigzag}
\end{minipage} \hspace{4.2cm}
\begin{minipage}[c]{0.1\textwidth}
\vspace{0.3cm}
\includegraphics[scale = 0.22]{Introduction/comparisonMF.pdf}
\end{minipage}
\vspace{-0.5cm}
...
\vspace{-0.5cm}
\centering
\includegraphics[scale = 0.3]{Introduction/grapheneNanoribbons.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.25]{Introduction/nanoribbons}
