...
\begin{figure}[H]
\hspace{1.5cm}
\includegraphics[width = 2.8cm]{Introduction/graphene.png}
\hspace{2.5cm}
\includegraphics[width = 7cm]{Introduction/dispGraphene.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.28]{Introduction/tmd2.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.3]{Introduction/nanoribbons}
...
\vspace{-0.5cm}
\centering
\includegraphics[scale = 0.38]{Introduction/grapheneNanoribbons.jpg}
...
One of the members of the $D_{3h}$ point-group describing the symmetry of \ac{TMD} monolayers is the reflection operator by the $x-y$ plane (see Fig.(\ref{fig:tmdHex})).
