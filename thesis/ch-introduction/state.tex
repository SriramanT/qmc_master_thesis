...
\begin{figure}
\centering
\includegraphics[scale = 0.34]{Introduction/tmdProp}
...
\begin{figure}[H]
\includegraphics[scale = 0.2]{Introduction/grapheneNanoribbons.jpg}
\includegraphics[scale = 0.2]{Introduction/nanoribbons}
